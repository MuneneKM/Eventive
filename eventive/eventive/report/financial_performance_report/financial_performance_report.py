...
def get_columns():
    return [
        ...
        },
		{
            ...
            "fieldname": "event_expenses",
            "fieldtype": "Currency",
            "width": 150,
        },
        {
            "label": "Event Budget",
            "fieldname": "event_budget",
            "fieldtype": "Currency",
            "width": 150,
        },
        {
            "label": "Event Profit",
            "fieldname": "event_profit",
            "fieldtype": "Currency",
            "width": 150,
        },
    ]
...
def get_data(filters):
    ...
    for event in events:
        ...
        event_expenses = get_event_expenses(event.name)
        ...
        result.append({
            ...
            "event_budget": frappe.db.get_value("Main Event", event.name, "budget"),
            "event_profit": total_revenue - event_expenses,
        })

    return result

def get_event_expenses(event_name):
